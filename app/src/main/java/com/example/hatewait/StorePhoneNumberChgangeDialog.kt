...
//    val storePhoneLayout : TextInputLayout = customView?.findViewById<TextInputLayout>(R.id.store_phone_layout)!!
//    val storePhoneEditText : TextInputEditText = customView?.findViewById<TextInputEditText>(R.id.store_phone_editText)!!

    val storePhoneLayout : TextInputLayout by lazy {
    customView?.findViewById<TextInputLayout>(R.id.store_phone_layout)!!
    }
    val storePhoneEditText : TextInputEditText by lazy {
